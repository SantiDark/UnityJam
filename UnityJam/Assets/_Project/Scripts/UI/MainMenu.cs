...
namespace Subject626
{
    ...
    public class MainMenu : MonoBehaviour
    {
        ...
        public void Build(System.Action onPlay)
        {
            ...
            // Overlay oscuro translúcido: deja ver la cámara del menú con la habitación de fondo.
            Image background = UIFactory.Stretch(canvas.transform, new Color(0.02f, 0.02f, 0.035f, 0.58f));
